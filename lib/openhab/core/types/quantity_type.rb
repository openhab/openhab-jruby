  ...
  module Core
    module Types
      ...
      class QuantityType
        ...
        # @return [nil] if the unit is not time-based
        #
        def to_duration
          Duration.of_nanos(to_unit("ns").to_i) if unit.compatible?(Units::SECOND)
        end
        ...
        def to_temporal_amount
          to_duration || (raise TypeError, "#{self} is not a time-based Quantity")
        end
